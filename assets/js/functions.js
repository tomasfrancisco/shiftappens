$(document).ready(function() {
	...
	setTimeout(function() {
		...
		var feed = new Instafeed({
	        ...
	        target: 'home',
	        template: '<style>#home{background-image:url({{image}});background-repeat:no-repeat; background-position: center; background-size: auto 100%;  filter: alpha(Opacity=30);}</style>'
	    });
	    feed.run();
	}, 1000);
